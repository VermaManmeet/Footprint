...
class Phys_Add_Meta_Box {
	...
	public function display( $field ) {
		...
		switch ( $field['type'] ) {
			...
			case 'group':
				if ( isset( $field['fields'] ) ) {
					echo '<div class="form-field physpress-meta-box-group ' . esc_attr( $field['id'] ) . '_field " data-hide="' . esc_attr( ! empty( $field['hidden'] ) ? htmlentities( wp_json_encode( $field['hidden'] ) ) : '' ) . '">';
